...
sudo ip link set sw2 netns host1
sudo ip netns exec host1 sudo ip link set sw2 address 32:fb:fa:c6:67:02
sudo ip netns exec host1 sudo ip -4 addr add 192.168.222.2/24 dev sw2
sudo ip netns exec host1 sudo ip link set sw2 up
